...
public class test_cast extends AbstractCTest {

    private final int bound;

    public test_cast(String name, Arch target, Result expected, int bound) {
    ...
    protected Provider<String> getProgramPathProvider() {
        return () -> "/home/lightone/Code/Dat3M/dartagnan/src/test/resources/ptr/test_cast.ll";
    }
